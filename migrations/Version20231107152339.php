 ...
 */
final class Version20231107152339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE sites_no_site_id sites_no_site_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` CHANGE sites_no_site_id sites_no_site_id INT NOT NULL');
    }
}
